...
class WebHeaderAuthentication(object):
    ...
    def __init__(self, base_url=None, enabled=None, headers=None, id=None, links=None, login_regular_expression=None, name=None, service=None, _configuration=None):  # noqa: E501
