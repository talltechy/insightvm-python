...
class UserEdit(object):
    ...
    def __init__(self, authentication=None, email=None, enabled=None, id=None, locale=None, locked=None, login=None, name=None, password=None, password_reset_on_login=None, role=None, _configuration=None):  # noqa: E501
