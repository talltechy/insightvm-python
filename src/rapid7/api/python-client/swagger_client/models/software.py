...
class Software(object):
    ...
    def __init__(self, configurations=None, cpe=None, description=None, family=None, id=None, product=None, type=None, vendor=None, version=None, _configuration=None):  # noqa: E501
