...
class GlobalScan(object):
    ...
    def __init__(self, assets=None, duration=None, end_time=None, engine_id=None, engine_ids=None, engine_name=None, id=None, links=None, message=None, scan_name=None, scan_type=None, site_id=None, site_name=None, start_time=None, started_by=None, started_by_username=None, status=None, vulnerabilities=None, _configuration=None):  # noqa: E501
        ...
        self._started_by_username = None
        self._status = None
        ...
        if started_by_username is not None:
            self.started_by_username = started_by_username
    ...
    @property
    def engine_ids(self):
        """Gets the engine_ids of this GlobalScan.  # noqa: E501

        ${scan.engine.ids}  # noqa: E501

        :return: The engine_ids of this GlobalScan.  # noqa: E501
        :rtype: list[EngineID]
        """
        return self._engine_ids

    @engine_ids.setter
    def engine_ids(self, engine_ids):
        """Sets the engine_ids of this GlobalScan.

        ${scan.engine.ids}  # noqa: E501

        :param engine_ids: The engine_ids of this GlobalScan.  # noqa: E501
        :type: list[EngineID]
        """
    ...
    @property
    def started_by_username(self):
        """Gets the started_by_username of this GlobalScan.  # noqa: E501

        ${scan.username}  # noqa: E501

        :return: The started_by_username of this GlobalScan.  # noqa: E501
        :rtype: str
        """
        return self._started_by_username

    @started_by_username.setter
    def started_by_username(self, started_by_username):
        """Sets the started_by_username of this GlobalScan.

        ${scan.username}  # noqa: E501

        :param started_by_username: The started_by_username of this GlobalScan.  # noqa: E501
        :type: str
        """

        self._started_by_username = started_by_username
