...
class Solution(object):
    ...
    def __init__(self, additional_information=None, applies_to=None, estimate=None, id=None, links=None, steps=None, summary=None, type=None, _configuration=None):  # noqa: E501
