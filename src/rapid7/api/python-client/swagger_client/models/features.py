...
class Features(object):
    ...
    def __init__(self, adaptive_security=None, agents=None, dynamic_discovery=None, early_access=None, engine_pool=None, insight_platform=None, mobile=None, multitenancy=None, policy_editor=None, policy_manager=None, remediation_analytics=None, reporting=None, scanning=None, _configuration=None):  # noqa: E501
