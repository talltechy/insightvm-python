...
class License(object):
    ...
    def __init__(self, edition=None, evaluation=None, expires=None, features=None, limits=None, links=None, perpetual=None, status=None, _configuration=None):  # noqa: E501
