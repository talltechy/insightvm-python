...
class ScanEngine(object):
    ...
    def __init__(self, address=None, content_version=None, id=None, is_aws_pre_auth_engine=None, last_refreshed_date=None, last_updated_date=None, links=None, name=None, port=None, product_version=None, serial_number=None, sites=None, status=None, _configuration=None):  # noqa: E501
        ...
        self._id = None
        self._is_aws_pre_auth_engine = None
        ...
        if id is not None:
            self.id = id
        if is_aws_pre_auth_engine is not None:
            self.is_aws_pre_auth_engine = is_aws_pre_auth_engine
    ...
    @property
    def is_aws_pre_auth_engine(self):
        """Gets the is_aws_pre_auth_engine of this ScanEngine.  # noqa: E501

        A boolean of whether the Engine is of type AWS Pre Authorized  # noqa: E501

        :return: The is_aws_pre_auth_engine of this ScanEngine.  # noqa: E501
        :rtype: bool
        """
        return self._is_aws_pre_auth_engine

    @is_aws_pre_auth_engine.setter
    def is_aws_pre_auth_engine(self, is_aws_pre_auth_engine):
        """Sets the is_aws_pre_auth_engine of this ScanEngine.

        A boolean of whether the Engine is of type AWS Pre Authorized  # noqa: E501

        :param is_aws_pre_auth_engine: The is_aws_pre_auth_engine of this ScanEngine.  # noqa: E501
        :type: bool
        """

        self._is_aws_pre_auth_engine = is_aws_pre_auth_engine
    ...
    def serial_number(self):
        """Gets the serial_number of this ScanEngine.  # noqa: E501

        ${scan.engine.serial.number  # noqa: E501

        :return: The serial_number of this ScanEngine.  # noqa: E501
        :rtype: str
        """
    ...
    def serial_number(self, serial_number):
        """Sets the serial_number of this ScanEngine.

        ${scan.engine.serial.number  # noqa: E501

        :param serial_number: The serial_number of this ScanEngine.  # noqa: E501
        :type: str
        """
