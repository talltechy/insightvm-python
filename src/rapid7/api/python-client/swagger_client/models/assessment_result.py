...
class AssessmentResult(object):
    ...
    def __init__(self, check_id=None, exceptions=None, key=None, links=None, port=None, proof=None, protocol=None, since=None, status=None, _configuration=None):  # noqa: E501
