...
class RiskTrendResource(object):
    ...
    def __init__(self, all_assets=None, asset_group_membership=None, asset_groups=None, assets=None, _from=None, sites=None, tag_membership=None, tags=None, to=None, _configuration=None):  # noqa: E501
    ...
    def asset_group_membership(self, asset_group_membership):
        ...
        if (self._configuration.client_side_validation and
                asset_group_membership not in allowed_values):
            raise ValueError(
    ...
    def asset_groups(self, asset_groups):
        ...
        if (self._configuration.client_side_validation and
                asset_groups not in allowed_values):
            raise ValueError(
    ...
    def tag_membership(self, tag_membership):
        ...
        allowed_values = ["historical", "generation"]  # noqa: E501
        if (self._configuration.client_side_validation and
                tag_membership not in allowed_values):
            raise ValueError(
