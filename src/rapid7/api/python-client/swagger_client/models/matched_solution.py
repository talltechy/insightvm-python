...
class MatchedSolution(object):
    ...
    def __init__(self, additional_information=None, applies_to=None, confidence=None, estimate=None, id=None, links=None, matches=None, steps=None, summary=None, type=None, _configuration=None):  # noqa: E501
    ...
    def confidence(self, confidence):
        ...
        if (self._configuration.client_side_validation and
                confidence not in allowed_values):
            raise ValueError(
