...
class SoftwareCpe(object):
    ...
    def __init__(self, edition=None, language=None, other=None, part=None, product=None, sw_edition=None, target_hw=None, target_sw=None, update=None, v2_2=None, v2_3=None, vendor=None, version=None, _configuration=None):  # noqa: E501
