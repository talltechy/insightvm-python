...
class WebFormAuthentication(object):
    ...
    def __init__(self, base_url=None, enabled=None, id=None, links=None, login_regular_expression=None, login_url=None, name=None, service=None, _configuration=None):  # noqa: E501
