...
class Agent(object):
    ...
    def __init__(self, addresses=None, agent_id=None, assessed_for_policies=None, assessed_for_vulnerabilities=None, configurations=None, databases=None, files=None, history=None, host_name=None, host_names=None, id=None, ids=None, ip=None, last_assessed_for_vulnerabilities=None, links=None, mac=None, os=None, os_certainty=None, os_fingerprint=None, raw_risk_score=None, risk_score=None, services=None, software=None, type=None, user_groups=None, users=None, vulnerabilities=None, _configuration=None):  # noqa: E501
        ...
        if os is not None:
            self.os = os
        if os_certainty is not None:
            self.os_certainty = os_certainty
    ...
    def last_assessed_for_vulnerabilities(self, last_assessed_for_vulnerabilities):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and last_assessed_for_vulnerabilities is None:
    ...
    @property
    def os_certainty(self):
        """Gets the os_certainty of this Agent.  # noqa: E501

        ${asset.os.certainty}  # noqa: E501

        :return: The os_certainty of this Agent.  # noqa: E501
        :rtype: str
        """
        return self._os_certainty

    @os_certainty.setter
    def os_certainty(self, os_certainty):
        """Sets the os_certainty of this Agent.

        ${asset.os.certainty}  # noqa: E501

        :param os_certainty: The os_certainty of this Agent.  # noqa: E501
        :type: str
        """

        self._os_certainty = os_certainty
