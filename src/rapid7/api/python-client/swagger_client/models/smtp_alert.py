...
class SmtpAlert(object):
    ...
    def __init__(self, enabled=None, enabled_scan_events=None, enabled_vulnerability_events=None, id=None, limit_alert_text=None, links=None, maximum_alerts=None, name=None, notification=None, recipients=None, relay_server=None, sender_email_address=None, _configuration=None):  # noqa: E501
    ...
    def maximum_alerts(self, maximum_alerts):
        ...
        if (self._configuration.client_side_validation and
                maximum_alerts is not None and maximum_alerts < 1):  # noqa: E501
    ...
    def notification(self, notification):
        ...
        if (self._configuration.client_side_validation and
                notification not in allowed_values):
            raise ValueError(
    ...
    def relay_server(self, relay_server):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and relay_server is None:
