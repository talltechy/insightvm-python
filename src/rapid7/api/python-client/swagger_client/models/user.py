...
class User(object):
    ...
    def __init__(self, authentication=None, email=None, enabled=None, id=None, links=None, locale=None, locked=None, login=None, name=None, role=None, _configuration=None):  # noqa: E501
