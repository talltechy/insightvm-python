...
class AssetGroup(object):
    ...
    def __init__(self, assets=None, description=None, id=None, links=None, name=None, risk_score=None, search_criteria=None, type=None, vulnerabilities=None, _configuration=None):  # noqa: E501
