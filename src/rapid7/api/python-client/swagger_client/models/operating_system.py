...
class OperatingSystem(object):
    ...
    def __init__(self, architecture=None, configurations=None, cpe=None, description=None, family=None, id=None, product=None, system_name=None, type=None, vendor=None, version=None, _configuration=None):  # noqa: E501
