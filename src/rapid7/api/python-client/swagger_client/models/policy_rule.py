...
class PolicyRule(object):
    ...
    def __init__(self, assets=None, benchmark=None, description=None, id=None, is_custom=None, links=None, name=None, role=None, scope=None, status=None, surrogate_id=None, title=None, _configuration=None):  # noqa: E501
