...
class PolicyItem(object):
    ...
    def __init__(self, assets=None, description=None, has_override=None, id=None, is_unscored=None, links=None, name=None, policy=None, rules=None, scope=None, status=None, title=None, type=None, _configuration=None):  # noqa: E501
