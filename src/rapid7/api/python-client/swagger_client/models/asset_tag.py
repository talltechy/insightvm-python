...
class AssetTag(object):
    ...
    def __init__(self, color=None, created=None, id=None, links=None, name=None, risk_modifier=None, search_criteria=None, source=None, sources=None, type=None, _configuration=None):  # noqa: E501
