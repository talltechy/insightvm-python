...
class Info(object):
    ...
    def __init__(self, cpu=None, disk=None, distinguished_name=None, fqdn=None, host=None, ip=None, jvm=None, links=None, memory=None, operating_system=None, serial=None, superuser=None, user=None, version=None, _configuration=None):  # noqa: E501
