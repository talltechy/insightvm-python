...
class ScanTemplateWebSpider(object):
    ...
    def __init__(self, dont_scan_multi_use_devices=None, include_query_strings=None, paths=None, patterns=None, performance=None, test_common_usernames_and_passwords=None, test_xss_in_single_scan=None, user_agent=None, _configuration=None):  # noqa: E501
