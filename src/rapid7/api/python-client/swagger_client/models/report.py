...
class Report(object):
    ...
    def __init__(self, baseline=None, bureau=None, component=None, email=None, enclave=None, filters=None, format=None, frequency=None, id=None, language=None, links=None, name=None, organization=None, owner=None, policies=None, policy=None, query=None, range=None, remediation=None, risk_trend=None, scope=None, storage=None, template=None, timezone=None, users=None, version=None, _configuration=None):  # noqa: E501
