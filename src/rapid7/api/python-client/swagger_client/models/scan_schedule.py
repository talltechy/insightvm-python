...
class ScanSchedule(object):
    ...
    def __init__(self, assets=None, duration=None, enabled=None, id=None, links=None, next_runtimes=None, on_scan_repeat=None, repeat=None, scan_engine_id=None, scan_name=None, scan_template_id=None, start=None, _configuration=None):  # noqa: E501
    ...
    def on_scan_repeat(self, on_scan_repeat):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and on_scan_repeat is None:
