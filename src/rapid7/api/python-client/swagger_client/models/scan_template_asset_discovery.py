...
class ScanTemplateAssetDiscovery(object):
    ...
    def __init__(self, collect_whois_information=None, fingerprint_minimum_certainty=None, fingerprint_retries=None, ip_fingerprinting_enabled=None, send_arp_pings=None, send_icmp_pings=None, tcp_ports=None, treat_tcp_reset_as_asset=None, udp_ports=None, _configuration=None):  # noqa: E501
    ...
    def fingerprint_minimum_certainty(self, fingerprint_minimum_certainty):
        ...
        if (self._configuration.client_side_validation and
                fingerprint_minimum_certainty is not None and fingerprint_minimum_certainty > 1):  # noqa: E501
            raise ValueError("Invalid value for `fingerprint_minimum_certainty`, must be a value less than or equal to `1`")  # noqa: E501
        if (self._configuration.client_side_validation and
                fingerprint_minimum_certainty is not None and fingerprint_minimum_certainty < 0):  # noqa: E501
    ...
    def fingerprint_retries(self, fingerprint_retries):
        ...
        """
        if (self._configuration.client_side_validation and
                fingerprint_retries is not None and fingerprint_retries > 1000):  # noqa: E501
            raise ValueError("Invalid value for `fingerprint_retries`, must be a value less than or equal to `1000`")  # noqa: E501
        if (self._configuration.client_side_validation and
                fingerprint_retries is not None and fingerprint_retries < 0):  # noqa: E501
