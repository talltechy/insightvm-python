...
class SiteCreateResource(object):
    ...
    def __init__(self, description=None, engine_id=None, importance=None, links=None, name=None, scan=None, scan_template_id=None, _configuration=None):  # noqa: E501
    ...
    def importance(self, importance):
        ...
        if (self._configuration.client_side_validation and
                importance not in allowed_values):
            raise ValueError(
