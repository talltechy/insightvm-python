...
class ScanTemplateWebSpiderPerformance(object):
    ...
    def __init__(self, http_daemons_to_skip=None, maximum_directory_levels=None, maximum_foreign_hosts=None, maximum_link_depth=None, maximum_pages=None, maximum_retries=None, maximum_time=None, response_timeout=None, threads_per_server=None, _configuration=None):  # noqa: E501
    ...
    def maximum_directory_levels(self, maximum_directory_levels):
        ...
        if (self._configuration.client_side_validation and
                maximum_directory_levels is not None and maximum_directory_levels > 100):  # noqa: E501
            raise ValueError("Invalid value for `maximum_directory_levels`, must be a value less than or equal to `100`")  # noqa: E501
        if (self._configuration.client_side_validation and
                maximum_directory_levels is not None and maximum_directory_levels < 1):  # noqa: E501
    ...
    def maximum_link_depth(self, maximum_link_depth):
        ...
        """
        if (self._configuration.client_side_validation and
                maximum_link_depth is not None and maximum_link_depth > 100):  # noqa: E501
            raise ValueError("Invalid value for `maximum_link_depth`, must be a value less than or equal to `100`")  # noqa: E501
        if (self._configuration.client_side_validation and
                maximum_link_depth is not None and maximum_link_depth < 0):  # noqa: E501
    ...
    def maximum_pages(self, maximum_pages):
        ...
        """
        if (self._configuration.client_side_validation and
                maximum_pages is not None and maximum_pages > 1000000):  # noqa: E501
            raise ValueError("Invalid value for `maximum_pages`, must be a value less than or equal to `1000000`")  # noqa: E501
        if (self._configuration.client_side_validation and
                maximum_pages is not None and maximum_pages < 0):  # noqa: E501
    ...
    def maximum_retries(self, maximum_retries):
        ...
        """
        if (self._configuration.client_side_validation and
                maximum_retries is not None and maximum_retries > 999):  # noqa: E501
            raise ValueError("Invalid value for `maximum_retries`, must be a value less than or equal to `999`")  # noqa: E501
        if (self._configuration.client_side_validation and
                maximum_retries is not None and maximum_retries < 0):  # noqa: E501
    ...
    def threads_per_server(self, threads_per_server):
        ...
        """
        if (self._configuration.client_side_validation and
                threads_per_server is not None and threads_per_server > 999):  # noqa: E501
            raise ValueError("Invalid value for `threads_per_server`, must be a value less than or equal to `999`")  # noqa: E501
        if (self._configuration.client_side_validation and
                threads_per_server is not None and threads_per_server < 0):  # noqa: E501
