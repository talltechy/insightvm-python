...
class SiteOrganization(object):
    ...
    def __init__(self, address=None, city=None, contact=None, country=None, email=None, job_title=None, links=None, name=None, phone=None, state=None, url=None, zip_code=None, _configuration=None):  # noqa: E501
