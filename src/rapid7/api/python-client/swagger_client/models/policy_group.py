...
class PolicyGroup(object):
    ...
    def __init__(self, assets=None, benchmark=None, description=None, id=None, links=None, name=None, policy=None, scope=None, status=None, surrogate_id=None, title=None, _configuration=None):  # noqa: E501
