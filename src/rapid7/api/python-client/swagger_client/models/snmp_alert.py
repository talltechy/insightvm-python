...
class SnmpAlert(object):
    ...
    def __init__(self, community=None, enabled=None, enabled_scan_events=None, enabled_vulnerability_events=None, id=None, links=None, maximum_alerts=None, name=None, notification=None, server=None, _configuration=None):  # noqa: E501
