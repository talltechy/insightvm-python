...
class AssetApi(object):
    ...
    def find_assets_with_http_info(self, param1, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('param1' not in params or
                                                       params['param1'] is None):  # noqa: E501
    ...
    def get_asset_service_web_application_with_http_info(self, id, protocol, port, web_application_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('web_application_id' not in params or
                                                       params['web_application_id'] is None):  # noqa: E501
